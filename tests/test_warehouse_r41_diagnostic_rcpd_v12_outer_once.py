...
from backend.training import warehouse_r41_diagnostic_rcpd_v12_outer_once as subject
...
def _fixture(tmp_path: Path, monkeypatch, *, fidelity: float = 0.95):
    ...
    promoted_rows = tmp_path / "promoted_v11_rows.npz"
    ...
    promoted_closeout_path = tmp_path / "promoted_v11_closeout.json"
    ...
    bindings = {
        ...
        "promoted_v11_rows_sha256": file_hash(promoted_rows),
    ...
    validation_wins = {
        ...
        "promoted_v11": deepcopy(promoted_audit),
    ...
    validation_hash_inputs = {
        ...
        "promoted_v11_closeout_sha256": file_hash(promoted_closeout_path),
        "promoted_v11_rows_sha256": file_hash(promoted_rows),
        "promoted_v11_rows_semantic_sha256": promoted_closeout[
            "consumed_outer"]["rows_semantic_sha256"],
        "promoted_v11_unique_observations": len(promoted_hashes),
        "promoted_v11_observation_hashes_sha256": digest(promoted_hashes),
    ...
    args = {
        ...
        "promoted_v11_closeout_path": promoted_closeout_path,
        "expected_promoted_v11_closeout_sha256": file_hash(
            promoted_closeout_path),
        "permanent_v11_outer_registry": tmp_path,
        ...
        "promoted_v11_rows_path": promoted_rows,
...
def test_source_closure_has_no_protected_final_or_holdout_module():
    ...
    assert "backend/training/warehouse_r41_diagnostic_rcpd_v12_outer_once.py" in sources
