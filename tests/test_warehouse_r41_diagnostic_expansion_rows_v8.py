...
SOURCE_DIR = ROOT / (
    ...
    "r41_diagnostic_expansion_collection_v8_fresh_outer_v2_sourceclosure_20260913"
)
SOURCE_COLLECTION_REPORT = SOURCE_DIR / "report.json"
SOURCE_ROWS = SOURCE_DIR / "expansion_rows.npz"
PRIOR_ROWS = ROOT / (
    "output/warehouse_native/r41_diagnostic_prior_rows_v8_sourceclosure4_20260913/"
    "rows.npz"
)
