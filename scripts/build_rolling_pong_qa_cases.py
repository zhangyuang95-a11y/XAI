...
def build():
    ...
    add('first-commitment',multi,'Which side have you committed to for the earlier team ball?','对于先到的大球，你已经承诺接哪一侧？',['assignment:0'],[{'decision_path':'assignments.0.locked','equals':True}])
