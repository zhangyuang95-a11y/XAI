"""Two-role legal branch queries for the genuine branch-feedback Actor runtime.
...
from backend import warehouse_branch_runtime as registry
...
VERSION = "warehouse-family-branch-runtime-feedback-samples.v1"
