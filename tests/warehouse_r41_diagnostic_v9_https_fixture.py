#!/usr/bin/env python3
"""Synthetic HTTPS service used only to exercise the v9 acceptance harnesses."""
...
from scripts.serve_warehouse_r41_diagnostic_v9_https import https_server
...
def main(argv=None):
    ...
    context.provenance.update(
        version=online.R41_DIAGNOSTIC_RELEASE_CONTEXT_VERSION_V9,
        actor_sha256="a" * 64,
    )
    context.runtime = MovingFixtureRuntime()
    context.explainer = LongFixtureExplainer()
    context.release["model_version"] = "synthetic-v9-harness-fixture"
