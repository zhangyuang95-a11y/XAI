...
function syncAutomaticDialog(){
 ...
 if(!dialog.open){
  ...
  if(anchor&&(anchor.y>innerHeight-70||anchor.y<130))window.scrollBy({top:anchor.y-innerHeight*.72,behavior:'instant'});
  dialog.showModal();$('confirmExplanationButton')?.focus({preventScroll:true});
 }
