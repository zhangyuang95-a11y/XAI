...
from backend.training import warehouse_r41_diagnostic_rcpd_v10_outer_once as subject
...
def test_source_closure_has_no_protected_final_or_holdout_module():
    ...
    assert "backend/training/warehouse_r41_diagnostic_rcpd_v10_outer_once.py" in sources
