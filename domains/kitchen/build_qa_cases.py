...
def build():
    ...
    heating_frames = regular_trace(1000)
    ...
    specs.extend([
        ...
        ('serve_net_points','served','Why did a +30 serving reward increase our score by only 29?','上菜奖励30分，为什么总分只增加29？',['serving_score_rule'],[{'fact_id':'serving_score_rule','contains':str(e.SERVE_POINTS)},{'fact_id':'serving_score_rule','contains':str(e.SERVE_POINTS-e.STEP_COST)}],'shared','rule'),
