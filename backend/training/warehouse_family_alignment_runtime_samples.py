"""Two-role legal branch queries for the genuine alignment-feedback Actor runtime.
...
from backend import warehouse_alignment_runtime as registry
...
VERSION = "warehouse-family-alignment-runtime-feedback-samples.v1"
