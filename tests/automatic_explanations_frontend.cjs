...
const callbacks=[],calls=[],nodes={englishButton:{},chineseButton:{},automaticExplanation:{remove(){this.removed=true;}}};
const context=vm.createContext({console,URLSearchParams,performance,setTimeout,clearTimeout,setInterval(){},
 ...
 document:{hidden:false,getElementById(id){return nodes[id]||null},addEventListener(){}},
