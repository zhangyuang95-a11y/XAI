...
This module coordinates the environment-independent extraction algorithm:
...
for the neural controller: the current NN supplies every extraction label.
The generic PPO integration gates program feedback on held-out fidelity and KL;
only neural on-policy actions participate in Actor updates.
