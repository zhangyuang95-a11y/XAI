#!/usr/bin/env python3
"""Run the r4.1-diagnostic v9 package over loopback HTTPS for acceptance.
...
authoritative server rejects state-changing requests from an HTTP origin.
This wrapper loads the exact portable v9 release through the production
loader, then wraps only the loopback listening socket in TLS.
"""
...
VERSION = "warehouse-r41-diagnostic-v9-loopback-https.v1"
