> Current three-domain release: [Kitchen v3.9 scoring revision and deployment status](docs/three_domain_deployment_v3_9.md). The sections below describe an earlier study version; use the versioned release documents for current behavior.
