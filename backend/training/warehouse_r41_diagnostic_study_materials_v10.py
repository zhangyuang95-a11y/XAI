"""Freeze the v10 diagnostic questionnaire and neutral tutorial.

This producer is deliberately downstream of the irrevocable v13 final audit.
...
VERSION = "warehouse-r41-diagnostic-study-materials.v10"
STATUS = "frozen_after_passed_v13_final_audit"
...
_FINAL_BINDINGS = frozenset((
    ...
    "projection_parity_file_sha256", "projection_parity_content_sha256",
))
...
def authenticate_release_inputs(
    *, actor: str | Path, expected_actor_sha256: str,
    ...
    combined_promoted_rows: str | Path,
    expected_combined_promoted_rows_sha256: str,
    promotion_closeout: str | Path,
    ...
    promoted_rows_path = _regular(
        combined_promoted_rows, "combined promoted development rows")
    if file_hash(promoted_rows_path) != _sha(
            expected_combined_promoted_rows_sha256,
            "combined promoted rows"):
        raise ValueError("Exact combined promoted development rows required")
    promoted_closeout_path = _regular(
        promotion_closeout, "v13 promotion closeout")
    promoted_closeout_value = promoted_closeout_api.read_saved_closeout_public(
        promoted_closeout_path,
        expected_closeout_sha256=_sha(expected_promotion_closeout_sha256,
    ...
    expected_lock = {
        ...
        "combined_promoted_rows_sha256": file_hash(promoted_rows_path),
    ...
    promoted_outer = promoted_closeout_value.get(
    ...
    if (not isinstance(promoted_outer, Mapping)
        ...
        raise ValueError("V13 closeout does not bind combined promoted rows")
    ...
    return {
        "paths": {
            ...
            "combined_promoted_rows": promoted_rows_path,
            "promotion_closeout": promoted_closeout_path,
        ...
        "final_audit": audit,
        "promotion_closeout": promoted_closeout_value,
    }
        ...
        receipt: dict[str, Any] = {
            ...
            "bindings": {
                **authenticated["hashes"],
                ...
                "promotion_closeout_content_sha256": authenticated[
                    "promotion_closeout"]["content_sha256"],
                "combined_promoted_rows_semantic_sha256": authenticated[
                    "promotion_closeout"]["combined_promoted_development"][
            ...
            "information_boundary": {
                ...
                "combined_promoted_rows_read": False,
                "promotion_closeout_permanently_authenticated": True,
