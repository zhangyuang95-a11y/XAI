...
RELEASE_ID = "policylens-three-domain-20260922.v3.11-consent"
KITCHEN_SUPPORTED_RELEASE_IDS = frozenset({RELEASE_ID, "policylens-three-domain-20260922.v3.10-prolific", "policylens-three-domain-20260922.v3.9"})
...
SUPPORTED_RELEASE_IDS = frozenset({RELEASE_ID, "policylens-three-domain-20260922.v3.10-prolific",
