"""Two-role legal branch queries for the genuine stable-feedback Actor runtime.
...
from backend import warehouse_stable_runtime as registry
...
VERSION = "warehouse-family-stable-runtime-feedback-samples.v1"
