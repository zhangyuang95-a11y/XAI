...
function task2Introduction(){return view.automatic_explanations_enabled?(lang==='zh'?'Task 2 中，AI 会在预设节点自动提供解释。你也可以主动追问；提问不消耗游戏回合。':'In Task 2, your AI teammate explains at preset points. You can also ask follow-up questions without using game turns.'):tr('task2Intro');}
