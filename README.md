> Current three-domain release: [Kitchen v3.8.2 tutorial update and deployment status](docs/three_domain_deployment_v3_8_2.md). The sections below describe an earlier study version; use the versioned release documents for current behavior.
